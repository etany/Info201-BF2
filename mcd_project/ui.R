...
# Define UI for application that draws a histogram
    ...
    tabPanel(
      ...
      titlePanel("About us"),
      hr(),
      h3("This project is created by a group of Univeristy of Washington students enrolled in Info201."),
      h4("Our team members include: "),
      h4("Jiafei Li"),
      h6( "Jiafei is a senior student pursuing Psychology and minoring in Informatics." ),
      h4("Erica Tan"),
      h6( "Erica is a senior student pursuing Sociolgy and minoring in Informatics."),
      h4("Khalifa Al-Maslamani"),
      h6("Khalifa is a junior student pursuing Economics."),
